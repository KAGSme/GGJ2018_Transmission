...
// Cross Module References
	...
	FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODOcclusionDetails();
	FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODAttenuationDetails();
	...
	FMODSTUDIO_API class UFunction* Z_Construct_UFunction_UFMODAudioComponent_GetProperty();
...
class UScriptStruct* FFMODOcclusionDetails::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODOcclusionDetails();
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODOcclusionDetails
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FFMODOcclusionDetails()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FMODOcclusionDetails"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FFMODOcclusionDetails>, EStructFlags(0x00000001));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bUseComplexCollisionForOcclusion, FFMODOcclusionDetails, bool);
			UProperty* NewProp_bUseComplexCollisionForOcclusion = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bUseComplexCollisionForOcclusion"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bUseComplexCollisionForOcclusion, FFMODOcclusionDetails), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bUseComplexCollisionForOcclusion, FFMODOcclusionDetails), sizeof(bool), true);
			UProperty* NewProp_OcclusionInterpolationTime = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OcclusionInterpolationTime"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OcclusionInterpolationTime, FFMODOcclusionDetails), 0x0010000000000005);
			UProperty* NewProp_OcclusionVolumeAttenuation = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OcclusionVolumeAttenuation"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OcclusionVolumeAttenuation, FFMODOcclusionDetails), 0x0010000000000005);
			UProperty* NewProp_OcclusionLowPassFilterFrequency = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OcclusionLowPassFilterFrequency"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OcclusionLowPassFilterFrequency, FFMODOcclusionDetails), 0x0010000000000005);
			UProperty* NewProp_OcclusionTraceChannel = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OcclusionTraceChannel"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(OcclusionTraceChannel, FFMODOcclusionDetails), 0x0010000000000005, Z_Construct_UEnum_Engine_ECollisionChannel());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnableOcclusion, FFMODOcclusionDetails, bool);
			UProperty* NewProp_bEnableOcclusion = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bEnableOcclusion"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableOcclusion, FFMODOcclusionDetails), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bEnableOcclusion, FFMODOcclusionDetails), sizeof(bool), true);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_bUseComplexCollisionForOcclusion, TEXT("Category"), TEXT("FMOD|Occlusion"));
			MetaData->SetValue(NewProp_bUseComplexCollisionForOcclusion, TEXT("EditCondition"), TEXT("bEnableOcclusion"));
			MetaData->SetValue(NewProp_bUseComplexCollisionForOcclusion, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_bUseComplexCollisionForOcclusion, TEXT("ToolTip"), TEXT("Whether or not to enable complex geometry occlusion checks."));
			MetaData->SetValue(NewProp_OcclusionInterpolationTime, TEXT("Category"), TEXT("FMOD|Occlusion"));
			MetaData->SetValue(NewProp_OcclusionInterpolationTime, TEXT("ClampMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_OcclusionInterpolationTime, TEXT("EditCondition"), TEXT("bEnableOcclusion"));
			MetaData->SetValue(NewProp_OcclusionInterpolationTime, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_OcclusionInterpolationTime, TEXT("ToolTip"), TEXT("The amount of time in seconds to interpolate to the target OcclusionLowPassFilterFrequency when a sound is occluded."));
			MetaData->SetValue(NewProp_OcclusionInterpolationTime, TEXT("UIMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("Category"), TEXT("FMOD|Occlusion"));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("ClampMax"), TEXT("1.0"));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("ClampMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("EditCondition"), TEXT("bEnableOcclusion"));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("ToolTip"), TEXT("The amount of volume attenuation to apply to sounds which are occluded."));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("UIMax"), TEXT("1.0"));
			MetaData->SetValue(NewProp_OcclusionVolumeAttenuation, TEXT("UIMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_OcclusionLowPassFilterFrequency, TEXT("Category"), TEXT("FMOD|Occlusion"));
			MetaData->SetValue(NewProp_OcclusionLowPassFilterFrequency, TEXT("ClampMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_OcclusionLowPassFilterFrequency, TEXT("EditCondition"), TEXT("bEnableOcclusion"));
			MetaData->SetValue(NewProp_OcclusionLowPassFilterFrequency, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_OcclusionLowPassFilterFrequency, TEXT("ToolTip"), TEXT("The low pass filter frequency (in hertz) to apply if the sound playing in this audio component is occluded. This will override the frequency set in LowPassFilterFrequency. A frequency of 0.0 is the device sample rate and will bypass the filter."));
			MetaData->SetValue(NewProp_OcclusionLowPassFilterFrequency, TEXT("UIMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_OcclusionTraceChannel, TEXT("Category"), TEXT("FMOD|Occlusion"));
			MetaData->SetValue(NewProp_OcclusionTraceChannel, TEXT("EditCondition"), TEXT("bEnableOcclusion"));
			MetaData->SetValue(NewProp_OcclusionTraceChannel, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_OcclusionTraceChannel, TEXT("ToolTip"), TEXT("Which trace channel to use for audio occlusion checks."));
			MetaData->SetValue(NewProp_bEnableOcclusion, TEXT("Category"), TEXT("FMOD|Occlusion"));
			MetaData->SetValue(NewProp_bEnableOcclusion, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_bEnableOcclusion, TEXT("ToolTip"), TEXT("Enable Occlusion Settings."));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FFMODOcclusionDetails_CRC() { return 3469988896U; }
class UScriptStruct* FFMODAttenuationDetails::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FMODSTUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FFMODAttenuationDetails();
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODAttenuationDetails
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FFMODAttenuationDetails()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FMODAttenuationDetails"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FFMODAttenuationDetails>, EStructFlags(0x00000001));
			UProperty* NewProp_MaximumDistance = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaximumDistance"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaximumDistance, FFMODAttenuationDetails), 0x0010000000000005);
			UProperty* NewProp_MinimumDistance = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MinimumDistance"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MinimumDistance, FFMODAttenuationDetails), 0x0010000000000005);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bOverrideAttenuation, FFMODAttenuationDetails, uint8);
			UProperty* NewProp_bOverrideAttenuation = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bOverrideAttenuation"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bOverrideAttenuation, FFMODAttenuationDetails), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bOverrideAttenuation, FFMODAttenuationDetails), sizeof(uint8), false);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_MaximumDistance, TEXT("Category"), TEXT("FMOD|Attenuation"));
			MetaData->SetValue(NewProp_MaximumDistance, TEXT("ClampMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_MaximumDistance, TEXT("EditCondition"), TEXT("bOverrideAttenuation"));
			MetaData->SetValue(NewProp_MaximumDistance, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_MaximumDistance, TEXT("ToolTip"), TEXT("Override the event's 3D maximum distance."));
			MetaData->SetValue(NewProp_MaximumDistance, TEXT("UIMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_MinimumDistance, TEXT("Category"), TEXT("FMOD|Attenuation"));
			MetaData->SetValue(NewProp_MinimumDistance, TEXT("ClampMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_MinimumDistance, TEXT("EditCondition"), TEXT("bOverrideAttenuation"));
			MetaData->SetValue(NewProp_MinimumDistance, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_MinimumDistance, TEXT("ToolTip"), TEXT("Override the event's 3D minimum distance."));
			MetaData->SetValue(NewProp_MinimumDistance, TEXT("UIMin"), TEXT("0.0"));
			MetaData->SetValue(NewProp_bOverrideAttenuation, TEXT("Category"), TEXT("FMOD|Attenuation"));
			MetaData->SetValue(NewProp_bOverrideAttenuation, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(NewProp_bOverrideAttenuation, TEXT("ToolTip"), TEXT("Should we use Attenuation set in Studio or be able to modify in Editor."));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FFMODAttenuationDetails_CRC() { return 3815656616U; }
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_GetProperty()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetProperty"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventGetProperty_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ReturnValue, FMODAudioComponent_eventGetProperty_Parms), 0x0010000000000580);
			UProperty* NewProp_Property = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Property"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(Property, FMODAudioComponent_eventGetProperty_Parms), 0x0010000000000080, Z_Construct_UEnum_FMODStudio_EFMODEventProperty());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Audio|FMOD|Components"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Get a property from the event"));
#endif
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UFMODAudioComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UFMODAudioComponent_GetProperty());
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_OcclusionDetails = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OcclusionDetails"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(OcclusionDetails, UFMODAudioComponent), 0x0010000000000005, Z_Construct_UScriptStruct_FFMODOcclusionDetails());
				UProperty* NewProp_AttenuationDetails = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AttenuationDetails"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(AttenuationDetails, UFMODAudioComponent), 0x0010000000000005, Z_Construct_UScriptStruct_FFMODAttenuationDetails());
				...
				UProperty* NewProp_ParameterCache = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ParameterCache"), RF_Public|RF_Transient|RF_MarkAsNative) UMapProperty(CPP_PROPERTY_BASE(ParameterCache, UFMODAudioComponent), 0x0010020000000005);
				UProperty* NewProp_ParameterCache_Key_KeyProp = new(EC_InternalUseOnlyConstructor, NewProp_ParameterCache, TEXT("ParameterCache_Key"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000001);
				UProperty* NewProp_ParameterCache_ValueProp = new(EC_InternalUseOnlyConstructor, NewProp_ParameterCache, TEXT("ParameterCache"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(FObjectInitializer(), EC_CppProperty, 1, 0x0000000000000001);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODAudioComponent_GetProperty(), "GetProperty"); // 543358776
				...
				MetaData->SetValue(NewProp_OcclusionDetails, TEXT("Category"), TEXT("FMODAudio"));
				MetaData->SetValue(NewProp_OcclusionDetails, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
				MetaData->SetValue(NewProp_OcclusionDetails, TEXT("ToolTip"), TEXT("FMOD Custom Attenuation Details"));
				MetaData->SetValue(NewProp_AttenuationDetails, TEXT("Category"), TEXT("FMODAudio"));
				MetaData->SetValue(NewProp_AttenuationDetails, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
				MetaData->SetValue(NewProp_AttenuationDetails, TEXT("ToolTip"), TEXT("FMOD Custom Attenuation Details"));
				...
				MetaData->SetValue(NewProp_bEnableTimelineCallbacks, TEXT("Category"), TEXT("FMODAudio"));
				...
				MetaData->SetValue(NewProp_ProgrammerSoundName, TEXT("Category"), TEXT("FMODAudio"));
				...
				MetaData->SetValue(NewProp_ParameterCache, TEXT("Category"), TEXT("FMODAudio"));
				MetaData->SetValue(NewProp_ParameterCache, TEXT("ModuleRelativePath"), TEXT("Classes/FMODAudioComponent.h"));
				MetaData->SetValue(NewProp_ParameterCache, TEXT("ToolTip"), TEXT("Event parameter cache"));
				MetaData->SetValue(NewProp_Event, TEXT("Category"), TEXT("FMODAudio"));
	...
	IMPLEMENT_CLASS(UFMODAudioComponent, 4201055311);
